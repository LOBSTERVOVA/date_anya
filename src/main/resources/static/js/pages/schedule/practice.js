...
// Хелпер: можно ли редактировать практики (ADMIN, MODERATOR, DEPARTMENT_ADMIN)
const canEditPractices = () => window.auth === true && window.user &&
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" id="practice-modal-save"${canEditPractices() ? '' : ' disabled'}>
...
async function onSavePractice() {
    ...
    if (editingPracticeUuid) {
        try {
            ...
            if (saveBtn) {
                saveBtn.disabled = !canEditPractices();
                const spinner = saveBtn.querySelector('.spinner-border');
